                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">CEK LIST OBSERVASI PRAKTEKREKRUTMEN CALON INSTRUKTUR ISDC – R4</h1>
                        <?php foreach($bank as $data) {  ?>
                    <input type="hidden" name="name" value="<?php echo $data['name']; ?>" class="form-control" placeholder="Name" readonly>
                    <?php } ?>
                    </div>
                    <div class="row">
