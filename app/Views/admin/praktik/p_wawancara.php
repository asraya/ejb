...
<div class="card border-left-primary shadow h-100 py-2">
        ...
        <div class="table-responsive">
            <div class="row no-gutters align-items-center">
                ...
                <form action="<?php echo base_url('master_data_peserta_wawancara/insert') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <input type="text" class="form-control" name="checked_by_wawancara" value="<?= user()->name; ?>" readonly>
                <input type="text" class="form-control" name="id_pewawancara" value="<?= user()->nrp; ?>" readonly>
            ...
            <table id="" class="table table-bordered">
                ...
                <?php $no=0; foreach($bank as $data) { $no++ ?>
                    ...
                    <tr>
                        ...
                        <td><center><input type="radio" id="<?php echo $data['id_soal']; ?>" name="list_jawaban_wawancara[<?php echo $data['id_soal'];?>]" value="kurang"></center></td>
                                    
                        <td><center><input type="radio" id="<?php echo $data['id_soal']; ?>" name="list_jawaban_wawancara[<?php echo $data['id_soal'];?>]" value="cukup"></center></td>
