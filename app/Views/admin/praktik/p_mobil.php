                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">FORM PENILAIAN PRAKTIK KENDARAAN RODA EMPAT</h1>
...
<div class="card border-left-primary shadow h-100 py-2">
        ...
        <div class="table-responsive">
            <div class="row no-gutters align-items-center">
                ...
                <form action="<?php echo base_url('master_data_peserta_mobil/insert') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            ...
            <table id="" class="table table-bordered">
                ...
                <?php $no=0; foreach($bank as $data) { $no++ ?>
                    ...
                    <tr>
                        ...
                        <td><center><input type="radio" id="<?php echo $data['id_soal']; ?>" name="list_jawaban_praktik[<?php echo $data['id_soal'];?>]" value="kurang"></center></td>
                                    
                        <td><center><input type="radio" id="<?php echo $data['id_soal']; ?>" name="list_jawaban_praktik[<?php echo $data['id_soal'];?>]" value="cukup"></center></td>
                                        
                        <td><center><input type="radio" id="<?php echo $data['id_soal']; ?>" name="list_jawaban_praktik[<?php echo $data['id_soal'];?>]" value="baik"></center></td>
                       <p style="display: none;"><input type="radio" checked id="<?php echo $data['id_soal']; ?>" name="list_jawaban_praktik[<?php echo $data['id_soal'];?>]" value="''">
